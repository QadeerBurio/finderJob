...
const SavedJobs = () => {
    ...
    useEffect(() => {
        getJobs();  // Corrected function call
    }, []);
    ...
    const removeSavedJob=(id)=>{
        firestore().collection('saved_jobs').doc(id).delete().then(()=>{
            getJobs();
                        ...
                        >
                            <View style={styles.topView}>
                                ...
                                <TouchableOpacity onPress={()=>{
                                    ...
                                    <Image source={require('../../images/lover.png')} style={styles.icon} />
                                </TouchableOpacity>
                            </View>
